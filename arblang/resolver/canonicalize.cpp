...
r_expr canonicalize(const resolved_variable& e, std::unordered_set<std::string>& reserved) {
...
r_expr canonicalize(const resolved_field_access& e, std::unordered_set<std::string>& reserved) {
    ...
    auto obj_canon = canonicalize(e.object, reserved);
